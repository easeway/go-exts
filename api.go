...
type Extension interface {
	...
	InvokeRaw(action string, params []byte) (Reply, error)
	Unload() error
}
...
//func (host ExtsHost) InvokeRaw(extName, action string, params []byte) (Reply, error) {
//	if ext := host.Find(extName); ext != nil {
//		return ext.InvokeRaw(action, params)
//	} else {
//		return errorExtNotLoaded
//	}
//}
